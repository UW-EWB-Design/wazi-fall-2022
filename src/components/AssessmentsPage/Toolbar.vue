<template>
    <div class="w-full flex justify-center">
        ...
        <button
            class="relative font-bold rounded-sm w-24 py-2 my-2 h-10 border border-black duration-300 hover:bg-gray-100"
            @click="openModal"
        >
        ...
        <FilterModal
            ...
            v-on:filter="advancedFilter"
        />
        <!-- Dropdown -->
        <div class="dropdown dropdown-container relative">
            <!-- Button -->
            <button
                class="dropdown dropdown-button buttonWidth flex justify-between rounded-sm w-max h-10 px-4 py-2 mt-2 mx-5 border border-black duration-300 hover:bg-gray-100"
            ...
            >
                <p class="dropdown dropdown-text">
                    View
                    <b class="dropdown dropdown-text"
                        >{{ filterProps.selected }} Assessments</b
                    >
                </p>
                <!-- Arrow -->
                <svg
